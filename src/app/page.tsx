...
const WORK_PROJECTS = [
  ...
  },
  {
    ...
    media: [
      ...
      { src: "/videos/Wild rose/kling_25_turbo_oil_drip_orbit_213420.mp4", type: "video" as const, isLandscape: true },
    ],
  },
  {
    id: 'merit',
  ...
  },
  {
    ...
    title: 'Abstracts',
    media: [
      { src: "/videos/Asbstracts/SH_Sisley_Animation.mp4", type: "video" as const, isLandscape: true },
      { src: "/videos/Asbstracts/SH_SAB_Motion_02.mp4", type: "video" as const, isLandscape: true },
    ],
  },
];
